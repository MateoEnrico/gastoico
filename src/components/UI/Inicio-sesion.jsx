  ...
  return (
    <div className="overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="modal">
        ...
        <p className="modal-subtitle" style={{ color: 'rgba(0, 57, 61, 0.7)', textAlign: 'center', fontSize: '13.5px', marginBottom: '22px', marginTop: '-4px', lineHeight: '1.4' }}>
          Empezá tu prueba gratuita de 30 días. <br /><strong style={{ color: 'var(--accent)' }}>No requiere tarjeta de crédito.</strong>
        </p>
